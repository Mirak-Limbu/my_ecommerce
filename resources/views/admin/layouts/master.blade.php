    ...
    <main class="d-flex flex-nowrap">
        ...
        <a href="#" class="nav-link active" aria-current="page">
          ...
          Home
                ...
                <li>
                    <a href="/home" class="nav-link text-white {{Request::is('home') ? 'active' : ''}}">
                ...
                <li class="nav-item">
                    <a href="/category-index" class="nav-link text-white {{Request::is('category-index') ? 'active' : ''}}" aria-current="page">
                ...
                <li>
                    <a href="/product-index" class="nav-link text-white {{Request::is('product-index') ? 'active' : ''}}">
                        <svg class="bi pe-none me-2" width="16" height="16">
                            <use xlink:href="#grid" />
                        </svg>
                        Products
